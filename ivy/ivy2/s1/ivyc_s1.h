...
public:
    ...
    virtual unsigned long long ext__vector__pretty__state____domain__prev(unsigned long long x);
    ...
    virtual unsigned long long ext__vector__ivy__type_context__stack_entry____domain__prev(unsigned long long x);
